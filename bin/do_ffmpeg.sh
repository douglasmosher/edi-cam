...
/home/root/bin/ffmpeg/ffmpeg -s 352x288 -f video4linux2 -i /dev/video0 -s 352x288 -f video4linux2 -i /dev/video1 -filter_complex "nullsrc=size=704x288 [base]; [0:v] setpts=PTS-STARTPTS, scale=352x288 [left]; [1:v] setpts=PTS-STARTPTS, scale=352x288 [right]; [base][left] overlay=shortest=1 [tmp1]; [tmp1][right] overlay=shortest=1:x=320" -f mpeg1video \
